...
<?php if (have_posts()) : ?>
    <div class="relative mx-2 static z-10 md:mx-16 lg:mx-[120px] breadcrumbs uppercase font-text text-grey lg:text-desktopLink md:text-tabletLink sm:text-mobileLink" typeof="BreadcrumbList" vocab="https://schema.org/">
